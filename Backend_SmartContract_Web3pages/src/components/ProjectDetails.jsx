        ...
        >
          ...
          <div className="flex-1 sm:py-0 py-4">
            <div className="flex flex-col justify-start flex-wrap">
              <h5 className="text-violet-500 text-xl font-medium mb-2">
                {project?.title}
              </h5>
            ...
            <div className="flex justify-between items-center w-full pt-1">
              <div className="flex justify-start space-x-2">
                ...
                <small className="text-gray-100 font-bold">
                  {project?.backers} Donator{project?.backers == 1 ? '' : 's'}
                </small>
              </div>
              ...
              <div className="font-bold">
                {expired ? (
                  ...
                  <small className="text-gray-100">Open</small>
                ) : project?.status == 1 ? (
                  <small className="text-green-500">Accepted</small>
                ) : project?.status == 2 ? (
                  <small className="text-gray-100">Reverted</small>
                ) : project?.status == 3 ? (
            ...
            <div>
              ...
              <div className="w-full overflow-hidden bg-gray-300 mt-4">
                <div
                  className="bg-violet-600 text-xs font-medium
